...
// Microsoft provider
var provider = new firebase_auth__WEBPACK_IMPORTED_MODULE_1__.OAuthProvider('microsoft.com');
...
window.microsoftLogin = function () {
  (0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.signInWithPopup)(auth, provider).then(function (result) {
    ...
    var credential = firebase_auth__WEBPACK_IMPORTED_MODULE_1__.OAuthProvider.credentialFromResult(result);
